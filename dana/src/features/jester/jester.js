...
export class Jester {
        ...
        exchanges: [
          {
            ...
            sourceArticleId: 'یوزپلنگ_آسیایی',
            verification: {
        ...
        exchanges: [
          {
            ...
            sourceArticleId: 'محمد_بن_موسی_خوارزمی',
            verification: {
  ...
  getCurrentExchange() {
    ...
    return {
      ...
      courseId: this.currentEncounter.trigger.split(':')[1] || 'nature',
      ...
      sourceArticleId: exchange.sourceArticleId,
    };
  }
