...
Paste this entire file at the top of a fresh AI chat (Claude, Cursor, Codex, Gemini CLI, Cline, Roo Code, or any system that accepts system prompts). It is the single source of truth for every AI agent working on this project. Do not paste partial sections. Do not paste individual spec files without this manual above them.
...
Anthropic's own research found agents drift toward content farms unless told not to. Do not drift.
